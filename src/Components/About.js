    ...
    return (
        <div class = "container my-3">
            ...
            <div className="accordion-item">
                ...
                <div className="accordion-body">
                    <ul class="list-group">
                        <li class="list-group-item">C++ Database for Bank</li>
                        <li class="list-group-item">Python Alien Invasion Game</li>
                        <li class="list-group-item">Facebook clone using HTML and CSS</li>
                    </ul>
