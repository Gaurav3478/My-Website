...
function Navbar(props) {
    ...
    return (
        <div>
            <nav className="navbar navbar-expand-lg navbar-light bg-warning ml  -auto">
            <div className="container-fluid">
                ...
                <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <Link className={`nav-link ${HomeActive}`} aria-current="page" to="/" onClick={BoldHomeActive}></Link>
                    </li>
                    <li className="nav-item">
